  ...
  return (
    <div className="row mt-3 ml-5">
      <div className="col-6">
        ...
        <input type="text" value={hotelname} onChange={(e)=>setHotelname(e.target.value)} className="form-control" />
        ...
        <div className="row">
          <div className="col-10">
            <button type="button" onClick={handlecreateroom}  className="btn btn-primary" >Upload</button>
          </div>
